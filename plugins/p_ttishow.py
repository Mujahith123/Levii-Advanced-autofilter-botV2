...
from info import ADMINS, LOG_CHANNEL, SUPPORT_CHAT, MELCOW_NEW_USERS, MELCOW_VID, CHNL_LNK, GRP_LNK, USERNAME
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            ...
            InlineKeyboardButton('Owner', url=f'https://t.me/user_is_leo')
        ],[
